...
import { userDetailsPageProps } from '../../ts/interface_and_types'
import { SyncLoader } from 'react-spinners'

export const UserDetails = ({dropDownActive,setDropDownActive,showSideBar,setShowSideBar}:userDetailsPageProps) => {
    const { id } = useParams()
